...
È vera. Ed è anche il punto di arrivo di una storia che quasi nessuno racconta per intero, perché la versione breve — *ci hanno tolto il diritto di scegliere* — sbaglia sia il colpevole sia il momento.

Il diritto di indicare la persona non è stato abolito da nessuno con un colpo di mano. È stato ridotto in **tre passaggi**, ciascuno con una ragione difendibile, e **il risultato finale non l'ha deciso nessuno.**

## Primo passaggio: lo abbiamo votato noi

Il **9 giugno 1991** si tenne un referendum per abrogare la **preferenza plurima** alla Camera: fino ad allora l'elettore poteva indicare più nomi sulla stessa scheda.

Passò con il **95,57% dei sì** e un'affluenza intorno al 65%. Non fu una riforma calata dall'alto: fu una delle vittorie referendarie più larghe della storia repubblicana.

E il motivo era serio. La preferenza plurima in circoscrizioni molto ampie alimentava le cosiddette **cordate**: gruppi di candidati che si scambiavano pacchetti di voti, con campagne elettorali dai costi sproporzionati e con tutto ciò che quei costi comportano in termini di dipendenza da chi li finanzia. Nel 1991, alla vigilia di Tangentopoli e nel pieno della stagione delle stragi, quel voto fu percepito come un argine alla corruzione.

Da lì in avanti la preferenza restò, ma una sola.

## Secondo passaggio: la preferenza sparisce del tutto

Con la **legge 270 del 21 dicembre 2005** — quella che il suo stesso relatore avrebbe poi definito «una porcata», e che da lì prese il soprannome — arrivano le **liste bloccate lunghe**.

L'elettore vota il simbolo. L'ordine dei candidati lo decide il partito, e i seggi si assegnano scorrendo quell'ordine dall'alto. **Non c'è più nessuna preferenza da esprimere.**

Con quella legge si è votato tre volte: 2006, 2008, 2013.

## Terzo passaggio: la Corte interviene, ma non dice quello che si crede

Il **13 gennaio 2014** viene depositata la [sentenza n. 1](https://www.cortecostituzionale.it/scheda-pronuncia/2014/1) della Corte costituzionale, che dichiara illegittime parti di quella legge, fra cui le liste bloccate.

Qui però va usata precisione, perché la versione diffusa è sbagliata, e sbagliata in un modo che conta.

**La Corte non ha dichiarato incostituzionali le liste bloccate in quanto tali.** Ha usato un criterio diverso: quello della **conoscibilità** dei candidati. Il problema del Porcellum era che le liste erano così lunghe da rendere impossibile all'elettore sapere chi stesse effettivamente votando. Liste bloccate compatibili con la conoscibilità restano ammissibili.

È una differenza decisiva, perché indica la strada che è stata poi presa.

## Il risultato: la legge con cui votiamo oggi

La **legge 165 del 3 novembre 2017**, il Rosatellum, ha raccolto esattamente quell'indicazione: mantiene le **liste bloccate**, ma le accorcia. Nei collegi plurinominali i candidati sono **non meno di due e non più di quattro**.

Liste corte significa candidati conoscibili, e conoscibilità significa che il criterio della Corte è rispettato. **La legge in vigore, su questo punto, è costituzionalmente legittima.**

Il che porta alla situazione di oggi, che va detta con esattezza perché è più sottile di come viene raccontata:

**L'elettore italiano oggi può sapere chi sta votando. Non può decidere quale di quei nomi entra in Parlamento.** Vede due, tre o quattro candidati; l'ordine con cui verranno eletti è stabilito dal partito prima che la scheda venga stampata.

Non è che manchi l'informazione. Manca la scelta.

## Perché nessuno ha deciso questo esito

Rimettiamo i tre passaggi in fila.

Nel 1991 gli italiani riducono le preferenze **per combattere la corruzione**, con una maggioranza schiacciante. Nel 2005 una legge le elimina del tutto. Nel 2014 la Corte costituzionale interviene, ma fissa un criterio — la conoscibilità — che è più stretto di «restituire la scelta». Nel 2017 il legislatore rispetta quel criterio nel modo meno impegnativo possibile: accorcia le liste, e la scelta resta al partito.

**Ogni passaggio è legittimo. Nessuno di questi quattro momenti aveva come obiettivo dichiarato togliere all'elettore la scelta della persona.** Eppure è quello che è successo, un passaggio alla volta, in ventisei anni.

È lo stesso schema che troviamo in [un'altra vicenda raccontata su questo sito](/i-posti-che-esistono-ogni-anno-e-restano-precari): una sentenza della Corte costituzionale toglie una norma ma non ne scrive una nuova, e il legislatore riempie il vuoto con la soluzione che costa meno — che quasi mai è quella che il problema chiedeva.

## La parte che i nostalgici saltano

Sarebbe comodo chiudere qui, con la richiesta di riavere le preferenze. Ma sarebbe disonesto, perché il problema che le fece ridurre **non è mai stato risolto**.

Le preferenze hanno un costo documentato e ben noto: spingono i candidati a farsi campagna gli uni contro gli altri **dentro lo stesso partito**, il che fa salire le spese elettorali e aumenta il peso di chi quelle spese le finanzia. È esattamente ciò contro cui votò il 95,57% degli italiani nel 1991, ed è la ragione per cui il tema resta divisivo anche fra chi non ha alcuna simpatia per le liste bloccate.

**Non esiste una versione del sistema senza svantaggi.** Le liste bloccate danno il potere ai partiti; le preferenze lo danno a chi finanzia le campagne. Chi presenta una delle due come la soluzione ovvia sta omettendo metà del problema.
...
«**Le liste bloccate sono incostituzionali**»: no. La Corte ha posto un criterio di conoscibilità, e liste corte lo soddisfano. La legge in vigore regge.

«**Ci hanno tolto le preferenze**»: no. La prima riduzione l'abbiamo votata noi nel 1991, con il 95% dei sì e per una ragione seria.
